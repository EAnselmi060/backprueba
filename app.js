...
fastify.register(mongoPlugin, {
  url: 'mongodb+srv://EAnselmi060:Lxe9jupr62BnJCIq@proydw.vs6az.mongodb.net/todo-list?retryWrites=true&w=majority&appName=ProyDW', //'mongodb://127.0.0.1:27017/todo-list', // Cambia 'crud_db' por el nombre de tu base de datos
}).after(err => {
  if (err) {
